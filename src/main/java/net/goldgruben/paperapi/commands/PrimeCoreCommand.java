...
import net.goldgruben.paperapi.managers.debugmessage.DebugMessage;
...
public class PrimeCoreCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
		...
		if (args.length == 0) {
			p.thePlayer()
			 .sendMessage("PrimeCore v" + GoldCore.getInstance().getDescription().getVersion() + " by PrimeAPI");
			...
			case "reload": {
				...
				switch (args[1].toLowerCase()) {
					case "scoreboard": {
						...
						GoldCore.getInstance().getScoreboardManager().sendScoreboard();
