package net.goldgruben.paperapi.managers.debugmessage;
...
public class DebugMessage {
	...
	public static DebugMessage send(String secret, Player sender) {
		...
		boolean mysql = GoldCore.getInstance().getConnection() != null;
		...
		try {
			...
			files.addAll(GoldCore.getInstance().getConfigManager().getAllFiles());
