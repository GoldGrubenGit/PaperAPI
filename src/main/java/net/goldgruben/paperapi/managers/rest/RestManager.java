package net.goldgruben.paperapi.managers.rest;
...
import net.goldgruben.paperapi.api.info.Info;
...
public class RestManager {
	...
	public void registerPlugin(RestPlugin plugin) {
		plugins.add(plugin);
		checked = false;
		GoldCore.getInstance().getLogger().log(Level.INFO, "Das Plugin " + plugin.getName() + " wurde registriert!");
	}
