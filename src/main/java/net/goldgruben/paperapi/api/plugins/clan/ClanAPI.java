package net.goldgruben.paperapi.api.plugins.clan;
...
import net.goldgruben.paperapi.sql.clan.SQLClanInvitation;
import net.goldgruben.paperapi.sql.clan.SQLPlayerAllocation;
...
public class ClanAPI {
	...
	public ClanAPI() {
		...
		if (online) {
			GoldCore.getInstance().getLogger().log(Level.INFO, "ClanAPI wurde geladen");
		} else {
			GoldCore.getInstance().getLogger().log(Level.INFO, "ClanAPI wurde NICHT geladen");
		}
	}
