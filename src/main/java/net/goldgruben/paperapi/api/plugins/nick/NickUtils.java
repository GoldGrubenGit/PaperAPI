package net.goldgruben.paperapi.api.plugins.nick;

import com.mojang.authlib.GameProfile;
import com.mojang.authlib.properties.Property;
import net.goldgruben.paperapi.GoldCore;
import net.goldgruben.paperapi.api.plugins.Skin;
import net.goldgruben.paperapi.managers.scoreboard.objects.utils.NMS;
...
public class NickUtils {
	...
	public static void setSkin(Player player, String value, String signature) {
		...
		try {
			Class<?> BUKKIT_PLAYER = Class.forName("org.bukkit.craftbukkit." + GoldCore.getInstance()
			                                                                            .getVersionManager()
			                                                                            .getNmsVersion() + ".entity" +
					                                       ".CraftPlayer");
			Class<?> ENTITY_PLAYER = GoldCore.getInstance().getVersionManager().getNMSClass("EntityPlayer");
			Class<?> HUMAN_PLAYER = GoldCore.getInstance().getVersionManager().getNMSClass("EntityHuman");
			...
			Class<?> PACKET_PLAYOUT_PLAYER_INFO = GoldCore.getInstance()
			                                               .getVersionManager()
			...
			Class<?> PACKET_PLAYOUT_ENTITY_DESTROY = GoldCore.getInstance()
			                                                  .getVersionManager()
			...
			Class<?> PACKET_PLAYOUT_ENTITY_SPAWN = GoldCore.getInstance()
			                                                .getVersionManager()
