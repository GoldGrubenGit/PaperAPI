package net.goldgruben.paperapi.api.plugins.friends;

import net.goldgruben.paperapi.GoldCore;
import net.goldgruben.paperapi.sql.SQLPlayer;
import net.goldgruben.paperapi.sql.friend.SQLFriendEntry;
import net.goldgruben.paperapi.sql.friend.SQLFriendRequest;
...
public class FriendsAPI {
	...
	public FriendsAPI() {
		...
		if (online) {
			GoldCore.getInstance().getLogger().log(Level.INFO, "FriendsAPI wurde geladen");
		} else {
			GoldCore.getInstance().getLogger().log(Level.INFO, "FriendsAPI wurde NICHT geladen");
		}
	}
