package net.goldgruben.paperapi.api.plugins.perms;

import net.goldgruben.paperapi.GoldCore;
import net.goldgruben.paperapi.sql.DatabaseTask;
import net.goldgruben.paperapi.sql.permissions.SQLGroup;
import net.goldgruben.paperapi.sql.permissions.SQLGroupPermission;
import net.goldgruben.paperapi.sql.permissions.SQLRanking;
import net.goldgruben.paperapi.sql.permissions.SQLUserPermission;
...
public class PermsAPI { //TOOD
	...
	public PermsAPI() {
		...
		if (online) {
			GoldCore.getInstance().getLogger().log(Level.INFO, "PermsAPI wurde geladen");
		} else {
			GoldCore.getInstance().getLogger().log(Level.INFO, "PermsAPI wurde NICHT geladen");
		}
	}
