package net.goldgruben.paperapi.api.command.reflections;

import net.goldgruben.paperapi.api.command.reflections.annotations.Command;
import net.goldgruben.paperapi.api.command.reflections.annotations.SubCommand;
